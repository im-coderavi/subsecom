        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-7">
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <div className="rounded-3xl overflow-hidden border border-line">
              <div className="relative bg-gradient-to-br from-[#3b4a64] via-[#2a3649] to-[#232e40] px-8 pt-10 pb-0 flex flex-col items-center overflow-hidden">
            ...
            {/* REVIEWS */}
            <div className="rounded-3xl bg-gradient-to-br from-[#3b4a64] to-[#232e40] border border-line p-7">
