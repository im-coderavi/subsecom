...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div className="bg-[#232e40] border-b border-line/70 overflow-hidden">
      ...
      {/* ── Main nav ── */}
      <header className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#2a3649]/90 backdrop-blur-xl border-b border-line shadow-lg shadow-black/30' : 'bg-transparent'}`}>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-[82%] max-w-[320px] bg-[#232e40] border-l border-line z-50 shadow-2xl flex flex-col lg:hidden"
            >
