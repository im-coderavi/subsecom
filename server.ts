...
import productRoutes from './api/_lib/routes/products';
import orderRoutes from './api/_lib/routes/orders';
import promoRoutes from './api/_lib/routes/promo';
import adminRoutes from './api/_lib/routes/admin';
